...
<div class="container">
    ...
    <div class="p-create">
        ...
        <div class="p-create__form form-group row mb-4">
            ...
            <input type=" text" name="product" class="form-control w-75 @error('product') is-invalid @enderror" value="{{ old('product') }}" autocomplete="product" autofocus>
        ...
        <div class="p-create__form form-group row mb-4">
            ...
            <input type="text" name="price" class="form-control w-75 @error('price') is-invalid @enderror" value=" {{ old('price') }}" autocomplete="price" autofocus>
            @if($errors->has('price'))
        ...
        <div class="p-create__form form-group row mb-4">
            ...
            <input type="text" name="stock" class="form-control w-75 @error('stock') is-invalid @enderror" value="{{ old('stock') }}" autocomplete="stock" autofocus>
            @if($errors->has('stock'))
        ...
        <div class="p-create__form form-group row mb-4">
            ...
            <textarea name="comment" class="form-control w-75" rows="3"></textarea>
        </div>
        <div class="p-create__form form-group row mb-5">
            <label for="" class="col-sm-4 col-form-label">商品画像</label>
            <input type="file" name="image" class="form-control w-75 @error('image') is-invalid @enderror" value="{{ old('image') }}">
            @if($errors->has('image'))
